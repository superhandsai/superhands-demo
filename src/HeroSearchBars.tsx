...
const FIELD_BASE =
  'group relative flex flex-col items-stretch justify-center gap-[2px] flex-[0_0_auto] self-stretch w-full box-border min-h-20 px-[13px] pt-[13px] pb-[9px] border-2 rounded-[16px] bg-white cursor-pointer'
const FIELD_LABEL =
