...
export function AirportField({
  ...
  return (
    ...
    >
      ...
      <div
        ref={controlRef}
        className={`group relative flex flex-col items-stretch justify-center gap-[2px] flex-[0_0_auto] self-stretch w-full box-border min-h-20 px-[13px] py-[9px] border-2 rounded-[16px] bg-white cursor-pointer text-[19px] ${desktopSeam} ${mobileSwapClearance} ${openSeamClasses}`}
      >
  ...
  return (
    <div className="box-border w-full p-6 text-[rgba(19,23,32,1)] bg-hero-search border border-[rgba(96,93,236,0.22)] rounded-[28px] flex flex-col items-start gap-8">
      <div className="flex flex-col items-start gap-8 w-full">
        ...
        <h1
          id="hero-heading"
          className="m-0 w-full max-w-none font-extrabold leading-auto text-left tracking-[-0.019999999999999574em] bg-hero-title bg-clip-text text-transparent lg:text-[74px]"
