...
export function AirportField({
  ...
  return (
    ...
    >
      ...
      <div
        ref={controlRef}
        className={`group relative flex flex-col items-stretch justify-center gap-[3px] flex-[0_0_auto] self-stretch w-full box-border min-h-20 px-[8px] py-[8px] border-2 border-t-dashed rounded-[16px] bg-white cursor-pointer ${desktopSeam} ${mobileSwapClearance} ${openSeamClasses}`}
      >
