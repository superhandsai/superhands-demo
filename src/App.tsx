...
export function AirportField({
  ...
  return (
    ...
    >
      ...
      <div
        ref={controlRef}
        className={`group relative flex flex-col items-stretch justify-center gap-[2px] flex-[0_0_auto] self-stretch w-full box-border min-h-20 px-[13px] py-[9px] border-2 rounded-l-[16px] rounded-r-[0px] max-md:rounded-[16px] bg-white cursor-pointer ${desktopSeam} ${mobileSwapClearance} ${openSeamClasses}`}
      >
