...
export function AirportField({
  ...
  const desktopSeam = isFirst
    ? 'md:rounded-r-none md:rounded-tr-none md:rounded-br-none md:pr-[28px]'
    : 'md:rounded-l-none md:rounded-r-none md:rounded-tr-none md:rounded-br-none md:pl-[38px] md:border-l-0'
  ...
  return (
    ...
    >
      ...
      <div
        ref={controlRef}
        className={`group relative flex flex-col items-stretch justify-center gap-[2px] flex-[0_0_auto] self-stretch w-full box-border min-h-20 px-[13px] py-[9px] max-md:pt-[16px] border-2 rounded-[16px] bg-white cursor-pointer ${desktopSeam} ${mobileSwapClearance} ${openSeamClasses}`}
      >
  ...
  return (
    <div className="box-border w-full p-6 text-[rgba(19,23,32,1)] bg-hero-search border border-[rgba(96,93,236,0.22)] rounded-[28px] flex flex-col items-start gap-8">
      <div className="flex flex-col items-start gap-8 w-full">
        ...
        <h1
          id="hero-heading"
          className="m-0 w-full max-w-none font-extrabold leading-[1.05] text-left tracking-[-0.02em] bg-hero-title bg-clip-text text-transparent text-[40px] lg:text-[56px]"
        >
          {HERO_HEADINGS[tab]}
        </h1>
      </div>
