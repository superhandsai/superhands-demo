  ...
  return (
    <div className="box-border w-full p-6 text-[rgba(19,23,32,1)] bg-hero-search border border-[rgba(96,93,236,0.22)] rounded-[28px] flex flex-col items-start gap-8">
      <div className="flex flex-col items-start gap-4 w-full">
        ...
        <h1
          id="hero-heading"
          className="m-0 w-full max-w-none font-extrabold leading-[1.05] text-left tracking-[-0.02em] bg-hero-title bg-clip-text text-transparent lg:text-[51px]"
  ...
  return (
    <div className={`relative w-auto max-w-none ${open ? 'z-[40]' : ''}`} ref={rootRef}>
      ...
      <button
        ...
        onClick={() => setOpen(o => !o)}
      >
        <span className="min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-[28px] font-semibold leading-[1.25] tracking-[0.02em]">
          {selected.label}
        </span>
