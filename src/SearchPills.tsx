    ...
    >
      {tabs.map(tab => {
        ...
        const stateClasses = selected
          ? 'bg-purple text-grey-100 border-purple hover:bg-purple-hover hover:border-purple-hover [&#_r_1_-flights]:opacity-85 [&#_r_1_-flights]:border-t-0'
          : 'bg-white text-grey-600 border-grey-200 hover:text-purple hover:border-purple [&#_r_1_-flights]:opacity-85 [&#_r_1_-flights]:border-t-0'
        const label = (
          <>
