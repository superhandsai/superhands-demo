...
export function SearchPills({
  ...
  return (
    <div
      id={pillsId}
      className="flex flex-wrap justify-start items-center gap-[12px] max-md:flex-nowrap max-md:gap-[6px] max-md:w-full"
    ...
    >
      {tabs.map(tab => {
        ...
        const stateClasses = selected
          ...
          : 'bg-white text-grey-600 border-grey-200 hover:bg-purple hover:border-purple hover:text-grey-600'
        const label = (
          <>
