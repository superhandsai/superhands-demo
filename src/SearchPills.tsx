      ...
      {tabs.map(tab => {
        ...
        const label = (
          <>
            ...
            <span className="font-bold text-[18px] drop-shadow-sm max-md:block max-md:max-w-full max-md:text-[11px] max-md:font-medium max-md:leading-[1.15] max-md:whitespace-normal max-md:break-words">
              {tab.label}
            </span>
          </>
        )
