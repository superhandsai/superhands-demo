...
export function DateRangeField({
  ...
  const dateFieldBase =
    'relative group flex-1 min-w-0 flex flex-col justify-center items-stretch gap-[2px] min-h-20 px-[13px] pt-[13px] pb-[9px] cursor-pointer bg-white border-2 rounded-[16px] box-border'
